...
const NFTCard: React.FC<NFTCardProps> = ({ name, description, imageUrl, tokenId }) => {
    return (

        <div className="flex flex-col justify-center items-center rounded-lg">
            <div className="!z-5 relative flex flex-col rounded-lg max-w-[300px] bg-clip-border shadow-3xl shadow-shadow-500  w-full !p-4 3xl:p-![18px] bg-white undefined">
                <div className="h-full w-full">
                    <div className="relative w-full">
                        <img src={imageUrl} className="mb-3 h-full w-full rounded-xl 3xl:h-full 3xl:w-full" alt="" />
                    ...
                    <div className="flex items-center justify-between md:items-center lg:justify-between ">
                        <div className="flex">
                            <p className="!mb-0 text-sm font-bold text-brand-500">Token Id: {tokenId}</p>
                        </div>
