...
var LoginMenuItemView = Backbone.Marionette.ItemView.extend({
  ...
  /* Ui events hash */
  events: {
    'click .connectWallet': 'onConnectWallet',
    'click .login': 'onLogin',
  ...
  onConnectWallet: function () {
    return new Promise(function (resolve, reject) {
      ...
      NavigationManager.getInstance().requestUserTriggeredNavigationLocked("LoginUserNavLockId");
      Session.connectWallet()
        ...
        .finally(function () {
        // unlock user triggered navigation
          NavigationManager.getInstance().requestUserTriggeredNavigationUnlocked("LoginUserNavLockId");
        });
        resolve();
      }).bind(this);
  },
