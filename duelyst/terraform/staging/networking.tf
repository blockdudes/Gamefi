...
module "internal_security_group" {
  ...
  ingress_configs = [
    ...
    #},
    {
      description = "Allow TCP/6900 from VPC"
      port        = 6900
      cidr_blocks = ["10.0.0.0/16"]
    },
    {
      description = "Allow TCP/6901 from VPC"
      port        = 6901
      cidr_blocks = ["10.0.0.0/16"]
    },
...
module "load_balancer_security_group" {
  ...
  ingress_configs = [
    ...
    {
      description = "Allows TCP/6900 from 0.0.0.0/0"
      port        = 6900
      cidr_blocks = ["0.0.0.0/0"]
    },
    {
      description = "Allows TCP/6901 from 0.0.0.0/0"
      port        = 6901
      cidr_blocks = ["0.0.0.0/0"]
    }
  ]
